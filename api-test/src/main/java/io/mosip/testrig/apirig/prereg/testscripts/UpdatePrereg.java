...
public class UpdatePrereg extends PreRegUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO) throws AuthenticationTestException, AdminTestException, SecurityXSSException {
        ...
        if (testCaseName.contains("_invalid_email")) {
            inputJson = replaceKeywordWithValue(inputJson, "$EMAILVALUE$", "@#$DDFFGG");
        }

        String phoneNumber = "";
        String email = testCaseName + "_" + BaseTestCase.runContext +"@mosip.com";
        ...
        if (testCaseDTO.getTestCaseName().toLowerCase().contains("_pos")) {

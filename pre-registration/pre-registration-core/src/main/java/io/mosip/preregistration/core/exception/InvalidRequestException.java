...
/**
 * The InvalidRequestException class represents an exception that occurs when an
 * invalid request parameter is encountered.. This class extends
...
public class InvalidRequestException extends BaseUncheckedException {
	...
	/**
	 * Constructs a new {@code InvalidRequestException} with the specified
	 ...
	 */
	public InvalidRequestException(String errorCode, String errorMessage, MainResponseDTO<?> response) {
	 ...
	 *                     information about the error.
	 */
	public InvalidRequestException(String errorCode, String errorMessage, Throwable rootCause,
	 ...
	 *                    information about the error.
	 */
	public InvalidRequestException(List<ExceptionJSONInfoDTO> exptionList, String operation,
			MainResponseDTO<?> response) {
		this.mainResponseDto = response;
		this.exptionList = exptionList;

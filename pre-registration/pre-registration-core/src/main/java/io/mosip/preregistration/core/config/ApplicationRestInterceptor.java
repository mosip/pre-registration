...
public class ApplicationRestInterceptor implements ClientHttpRequestInterceptor {

	private static final Logger LOGGER = LoggerFactory.getLogger(ApplicationRestInterceptor.class);

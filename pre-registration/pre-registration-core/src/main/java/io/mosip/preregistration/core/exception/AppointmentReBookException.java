...
/**
 * The AppointmentReBookException class represents an exception that occurs when
 * appointment rebooking fails. This class extends
...
public class AppointmentReBookException extends BaseUncheckedException {
	...
	/**
	 * Constructs a new {@code AppointmentReBookException} with the specified error
	 * errorMessage
	 * 
	 * @param errorMessage the detailed error errorMessage.
	 */
	public AppointmentReBookException(String errorMessage) {
		super("", errorMessage);
	}
	 ...
	 */
	public AppointmentReBookException(String errorMessage, Throwable rootCause) {
